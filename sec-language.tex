...
Rule~\StmtSeqRuleOne and \StmtSeqRuleTwo show how a statement representing a sequence of statements should be executed (\rg{more details on statement and expression level semantics we refer the readers in a future extended version of the paper}).
%
