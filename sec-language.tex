...
while the sensor and actuator ports of all robots change continuously with time.
However, the \lgname program can only read sampled values from and write to the ports every $\delta$ cycle.
