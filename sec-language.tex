...
\begin{mathpar}
    ...
    {
        \mathit{ev} = \s{pre } \mathit{Cond} \s{ eff }\mathit{Body} \land \\
        \agnt= (P,{M},\cp,\mathtt{prog}) \land \agnt^\prime = (P,{M},\cp,\mathtt{env}) \land \mathit{eval(\mathit{Cond}, L.M)}
    }
    {\langle{S},\agnt, \cdot \rangle {\rightarrow_{S}}  \langle{S},\agnt^\prime, \mathit{Body} \rangle }

    \inferrule*[Right=envtrans]{
...
\chiao{I will fix Rule reference later.}
