...
%
\marginpar{\scriptsize\sayan{$\delta$ subscript necessary? Looks odd.}}
%
...
\item $\lset_{i\in\UINS}$ or $\lset$ in short is an indexed set of \emph{robot configurations}--one for each participating robot,
  ...
  %
\marginpar{\scriptsize\sayan{$\UINS$ should be defined earlier with N\_SYS and pid. It was used in Invariant 1.}}
%    
...
%
\marginpar{\scriptsize\sayan{Was $P$ ever introduced?}}
%
...
%
\marginpar{\scriptsize\sayan{$\pi$ not defined. }}
%
