...
\newcommand{\three}[5]{
	...
	\lstdefinelanguage{koord}{
		...
		emph={update,replaceList,findTask,finishTask,beginTask,doMove, doReach, doReachA, forget, getOdometer, getInput, getMotion, getObs, getPos, getxPos, getPosition, getNeighbors, setMotion, inMotion, sharedsw, sharedmw, tuple, map, array, enumeration},
	}
	...
	\lstdefinelanguage{xyz}{
		...
		keywords={
			...
			variables, vocabulary,
			when,where, with,while},
		emph={g_update,l_update,replaceList,findTask,finishTask,beginTask,doMove, doReach, doReachA, forget, getOdometer, getInput, getMotion, getPos, getxPos, getPosition, getNeighbors, setMotion, inMotion, sharedsw, sharedmw, tuple, array, enumeration},
		literate=
		{(}{{$($}}1
		{)}{{$)$}}1
		% LaTeX math symbols
