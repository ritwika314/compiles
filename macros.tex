...
\newcommand{\pwl}{\mathbbm{C}} %all possible local configs
...
\newcommand{\stmtrule}{\rightarrow_S\xspace}
\newcommand{\sysrule}{\rightarrow_G\xspace}
\newcommand{\progtrans}{\rightarrow_{prog}\xspace}
\newcommand{\envtrans}{\rightarrow_{env}\xspace}
