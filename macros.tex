...
\newcommand{\lgname}{K\kern-2pt oord\xspace}
\newcommand{\toolname}{K\kern-2pt oordinator\xspace}
...
\newcommand{\Post}{\mathit{PostEvent}\xspace}
\newcommand{\Final}{\mathit{FinalEvent}\xspace}
%\newcommand{\Final}{\mathit{Final}\xspace}
\newcommand{\traj}{\mathit{traj}\xspace}
\newcommand{\pt}{\mathit{Post}_{[0,\delta]}}
\newcommand{\ft}{\mathit{Post}_\delta}
...
\newcommand{\three}[5]{
	...
	\lstdefinelanguage{koord}{
		...
		keywords={
			...
			return,
			sensor,
			then,def,type,types,thread,to,tasks,
			using,module
			variables, vocabulary,
			when,where, with,while},
		emph={replaceList,findTask,finishTask,beginTask,doMove, doReach, doReachA, forget, getOdometer, getInput, getMotion, getObs, getPos, getxPos, getPosition, getNeighbors, setMotion, inMotion, sharedsw, sharedmw, tuple, map, array, enumeration},
	}
	
	\lstdefinelanguage{koordNums}[]{xyz}
	{
		numbers=left,
		numbersep=15pt,
		numberstyle=\tiny,
	...
	\lstdefinelanguage{xyz}{
		%  basicstyle=\figuresize,
		keywordstyle=\bf, %\figuresize,
		identifierstyle=\it, % \figuresize,
		emphstyle=\starl, %\tt, % \figuresize,
		mathescape=true,
		tabsize=20,
		%  tabsize=4,
		sensitive=false,
		...
		keywords={
			...
			variables, vocabulary,
			when,where, with,while},
		emph={replaceList,findTask,finishTask,beginTask,doMove, doReach, doReachA, forget, getOdometer, getInput, getMotion, getPos, getxPos, getPosition, getNeighbors, setMotion, inMotion, sharedsw, sharedmw, tuple, array, enumeration},
		literate=
		{(}{{$($}}1
		{)}{{$)$}}1
		% LaTeX math symbols
...
%		{>}{{$>\$}}1
	...
	\lstdefinelanguage{xyzNumsRight}[]{xyz}
	{
		numbers=right,
		numbersep=15pt,
		numberstyle=\tiny,
...
\newcommand{\sensarea}{\mathit{sens}}
\newcommand{\lmap}{\mathit{LocalMap}}
\newcommand{\gmap}{\mathit{GlobalMap}}
\newcommand{\ff}{\mathit{frontier}}
\newcommand{\qdfunc}{quantized domain truth function}
