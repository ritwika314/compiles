...
\begin{definition} The \emph{sensing area} of a robot $i$ within a grid rectangle $q \in Q$ is defined by $\sensarea_i: Q \mapsto 2^{Q}$, such that the robot can \emph{correctly} compute $\world_Q(\sensarea(q))$. 
  \end{definition}
