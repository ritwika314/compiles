...
\end{cases}
$$
\rg{Consider also, that there is a set of ground robots $[N]$ in which each robot can can detect obstacles within a certain \emph{sensing area} (which we shall presently define) of the current position of the robot.} 
