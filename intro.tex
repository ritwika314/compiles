...
\begin{figure}[h!]
	\includegraphics[width=0.15\textwidth]{figs/firefly.png}
	\includegraphics[width=0.25\textwidth]{figs/shapeform_16.jpg}
	\caption{Swarm formation show by FireFly Inc. {\em Center\/} ...{\em Right\/} ShapeForm.}
\end{figure}
