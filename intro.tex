...
\item \emph{For the platform engineers} deploying the robot applications, our abstraction makes the \lgname programs portable across platforms.
      \rg{Moreover, our high-fidelity \lgname simulator can be used in conjunction with other reachability analysis tools to verify the exact same code without hardware deployment.}
\end{noinditem}
