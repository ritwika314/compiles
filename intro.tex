...
\rg{Motivation : \emph{expressive} Language design for  applications
}
...
semantics, \rg{and executable semantics}
simulator, hardware.

\rg{Outline implementation issues }
Synchronization, Timing, multithreading, controllers, sensor fusion  : motivates nailing down exact assumptions for any sort of guarantee.
