...
\PO{po:port-ass} can be validated with the \toolname simulator or verified separately by other tools specialized for continuous dynamics.
...
Hence, with \PO{po:port-ass} and \lem{lem:noninter},
...
In each case study, we describe the two proof obligations \PO{po:ind} and \PO{po:port-ass}
