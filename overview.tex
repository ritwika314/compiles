...
\begin{figure}[!htbp]
    \noindent
        \begin{center}
            \scriptsize
            \two{0.4}{0.6}
            {\lstinputlisting[language=xyzNums,firstline=1,lastline=22,frame=none]{code/mapapp.tex}}
            {\lstinputlisting[language=xyzNums,firstline=24,frame=none,firstnumber=22]{code/mapapp.tex}}
        \end{center}
