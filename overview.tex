...
Need to decide whether to use Task or DMap
Define the mapping problem or the task; challenges---sensing, perception, coordination.
}

%


We first give an overview of the mapping problem and the features of the programming language \lgname that enables us to design a succinct application for this problem.
...
\begin{figure}[!htbp]
    \noindent
        \begin{center}
            \two{0.4}{0.6}
            {\lstinputlisting[language=NumKoord,firstline=1,lastline=22,frame=none]{code/mapapp.tex}}
            {\lstinputlisting[language=NumKoord,firstline=24,frame=none,firstnumber=22]{code/mapapp.tex}}
        \end{center}
