...
Third, the inertia of the robot may force it go out of bound temporarily. We see through an example in \refsect{sec:verification} how the third scenario can be detected.}
