...
$\lgname$ provides mutual exclusion, as it is an essential requirement for any system using distributed shared memory. The \emph{Task} and \emph{Mapping} applications discussed in \refsect{verification} use \emph{atomic} blocks of statements to update shared variables in a mutually exclusive fashion.
