...
\newcommand{\ld}{\mathit{LocalDecls}}
...
\(\begin{array}{l@{\;}r@{\;}l}
    ...
    \type           &  ::= & \mterm{int}\mid \mterm{float}\mid\mterm{bool}\mid \mterm{pos}\mid \mathit{adt}                                       \\
                    & \mid & \type [\mathit{Int}]\mid \mterm{List}\left\langle\type\right\rangle \mid \mterm{Queue}\left\langle\type\right\rangle \\
                    &      &  \\
    \db             &  ::= & \awd\ \ard\ \ld                                                                                                      \\
