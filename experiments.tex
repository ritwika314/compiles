...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figs/exp-gazebo.jpg}\\
\includegraphics[width=0.3\linewidth]{figs/exp-progress-1.png}
\includegraphics[width=0.3\linewidth]{figs/exp-progress-2.png}
\includegraphics[width=0.3\linewidth]{figs/exp-progress-3.png}
