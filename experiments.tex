...
\begin{figure}[ht!]
    ...
    \begin{center}
        \scriptsize
        \two{0.4}{0.6}
        {\lstinputlisting[language=koordNums,firstline=1,lastline=21,frame=none]{code/platooning2.tex}}
        {\lstinputlisting[language=koordNums,firstline=22,frame=none,firstnumber=22]{code/platooning2.tex}}
    \end{center}
