...
Similarly, rule \textsc{Svar-assign} describes the semantics of assignment to a shared variable $x$ updates the agent configuration $L$ to $L'$ by modifying $L.M$
