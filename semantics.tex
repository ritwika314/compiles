...
\begin{itemize}
	...
	\item ${S} : \mathit{Var} \mapsto \mathit{Val}$ is a {\em global context\/} mapping each shared variable to a corresponding valuation.
...
\end{itemize}
The global configuration changes according to state transition rules or {\em update rules\/}. The  update rules are rewriting rules that model the changes in the agent configurations as well as the changes in the environment.  
