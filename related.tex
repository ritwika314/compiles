...
%
\sayan{
A position paper~\cite{ghosh_language_2018} proposes combining shared memory with physical interactions in a high-level language. This paper presents a detailed study on how to connect those.
